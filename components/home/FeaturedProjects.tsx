...
const FeaturedProjects = ({ projects }) => {
  return (
    ...
    <div className="w-full bg-[#005BA4] p-6 rounded-b-[96px] text-end relative ">
      <span className="font-technor text-2xl font-medium mr-28">View More Projects</span>
